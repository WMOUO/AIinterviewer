<template>
  ...
  <div class="cursor" :style="{ left: `${mouseX}px`, top: `${mouseY}px` }"></div>
    ...
    <!-- 上層 -->
      ...
      <div class="split-lr">
        <div class="left">
            <img src="/titletext.png" alt="titletext" class="image" />
        </div>

        <div class="right">
            <!-- 按鈕 -->
            <button @click="toggleModal" class="button-log">log in</button>
    ...
    <!-- 中層 -->
      <div class="mid-panel">
        <div class="split-lr">
          <div class="left">
            <!-- 圖片 -->
            <img src="/interview.jpg" alt="aiinterview" style="width: 300px; height: auto;" class="image-container" />
          </div>
    ...
    <!-- 下層 -->
      <div class="down-panel">
        <img src="/down.png" alt="titletext" class="image" />
      </div>
  ...
  <!-- 彈跳視窗 -->
     <div v-if="showModal" class="modal-overlay">
      <div class="modal-content">
        ...
        <input type="text" placeholder="帳號" class="input-field" />
        <input type="password" placeholder="密碼" class="input-field" />
        <button class="submit-button">登入</button>
...
.button-log:hover {
  /* border-color: blue; 滑鼠懸停時邊框變色 */
  background-color:rgb(177, 209, 243); /* 背景變淺藍色 */
}

.button-sign:hover {
  /* border-color: blue; 滑鼠懸停時邊框變藍色 */
...
.cursor {
  ...
  box-shadow: 0 0 15px 15px rgba(114, 105, 105, 0.6); /* 漸變的光暈效果 */
}
